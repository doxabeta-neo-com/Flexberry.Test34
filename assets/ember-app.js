...
define('ember-app/controllers/i-i-s-test34-new-class1-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-test34-new-class1-l'
  });
});
define('ember-app/controllers/i-i-s-test34-new-class1-e/new', ['exports', 'ember-app/controllers/i-i-s-test34-new-class1-e'], function (exports, _iISTest34NewClass1E) {
  'use strict';
  ...
  var IISTest34NewClass1ENewController = _iISTest34NewClass1E.default;
  exports.default = IISTest34NewClass1ENewController;
});
define('ember-app/controllers/i-i-s-test34-new-class1-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-test34-new-class1-e'
     */
    editFormRoute: 'i-i-s-test34-new-class1-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-test34-new-class1-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/forms/i-i-s-test34-new-class1-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/en/models/i-i-s-test34-new-class1", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-test34-new-class1-l', 'ember-app/locales/en/forms/i-i-s-test34-new-class1-e', 'ember-app/locales/en/models/i-i-s-test34-new-class1'], function (exports, _translations, _iISTest34NewClass1L, _iISTest34NewClass1E, _iISTest34NewClass) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-test34-new-class1': _iISTest34NewClass.default
    },
    ...
    forms: {
      ...
      'i-i-s-test34-new-class1-l': _iISTest34NewClass1L.default,
      'i-i-s-test34-new-class1-e': _iISTest34NewClass1E.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-test34-new-class1-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-test34-new-class1-l', ['exports'], function (exports) {
  'use strict';
...
define("ember-app/locales/ru/models/i-i-s-test34-new-class1", ["exports"], function (exports) {
  "use strict";
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-test34-new-class1-l', 'ember-app/locales/ru/forms/i-i-s-test34-new-class1-e', 'ember-app/locales/ru/models/i-i-s-test34-new-class1'], function (exports, _translations, _iISTest34NewClass1L, _iISTest34NewClass1E, _iISTest34NewClass) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-test34-new-class1', ['exports', 'ember-flexberry-data/utils/attributes'], function (exports, _attributes) {
  'use strict';
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('NewClass1E', 'i-i-s-test34-new-class1', {});

    modelClass.defineProjection('NewClass1L', 'i-i-s-test34-new-class1', {});
  };
});
define('ember-app/mixins/regenerated/serializers/i-i-s-test34-new-class1-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-test34-new-class1', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-test34-new-class1', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-test34-new-class1'], function (exports, _emberCpValidations, _model, _offlineModel, _iISTest34NewClass) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISTest34NewClass.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _iISTest34NewClass.Model, Validations, {});

  (0, _iISTest34NewClass.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    this.route('i-i-s-test34-new-class1-l');
    this.route('i-i-s-test34-new-class1-e', { path: 'i-i-s-test34-new-class1-e/:id' });
    this.route('i-i-s-test34-new-class1-e.new', { path: 'i-i-s-test34-new-class1-e/new' });
  });
...
define('ember-app/routes/i-i-s-test34-new-class1-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    ...
    modelName: 'i-i-s-test34-new-class1'
  });
});
define('ember-app/routes/i-i-s-test34-new-class1-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'NewClass1E',
    modelName: 'i-i-s-test34-new-class1',
    templateName: 'i-i-s-test34-new-class1-e'
  });
});
define('ember-app/routes/i-i-s-test34-new-class1-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
    ...
    */
    ...
    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-test34-new-class1'
    */
    modelName: 'i-i-s-test34-new-class1',
...
define('ember-app/serializers/i-i-s-test34-new-class1-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-test34-new-class1-offline', 'ember-app/serializers/application-offline'], function (exports, _iISTest34NewClass1Offline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISTest34NewClass1Offline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-test34-new-class1', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-test34-new-class1', 'ember-app/serializers/application'], function (exports, _iISTest34NewClass, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISTest34NewClass.Serializer, {
    /**
